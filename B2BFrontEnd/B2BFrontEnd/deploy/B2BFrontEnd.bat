set JAVA_HOME="C:\Program Files\Java\jdk1.5.0_11\bin\"
...
set CLASSPATH="%BASE_DIR%\classes;%BASE_DIR%\lib\jms.jar;%BASE_DIR%\jlib\aqapi.jar;%BASE_DIR%\lib\jta.jar;%BASE_DIR%\jdbc\lib\ojdbc14dms.jar;%BASE_DIR%\jdbc\lib\orai18n.jar;%BASE_DIR%\jdbc\lib\ocrs12.jar;%BASE_DIR%\diagnostics\lib\ojdl.jar;%BASE_DIR%\lib\dms.jar;%BASE_DIR%\lib\xmlparserv2.jar;%BASE_DIR%\lib\xml.jar"

%JAVA_HOME%\javaw.exe -client -classpath %CLASSPATH% b2bfrontend.B2BFrontEnd